...
public class SalaryGoalsView extends Composite {
	...
	private Button registerButton = new Button("Save Your Salary Goals");
	...
	SalaryGoalsView(){
		...
		vendorTable.setWidget(1, 0, new HTML("<b>Set Your Salary Goals</b>"));
		addGoalType();
	...
	public void addGoalType(){
	    ...
	    vendorTable.setWidget(2, 0, new HTML("What is your Salary Goal in the next 1 year?"));
	    vendorTable.setWidget(2, 1, businessName);
	    vendorTable.setWidget(3, 0, new HTML("What is your Salary Goal in the next 5 years?"));
		 vendorTable.setWidget(3, 1, product);
		 vendorTable.setWidget(4, 0, new HTML("What is your current Salary?"));
		 vendorTable.setWidget(4, 1, income);
		 vendorTable.setWidget(4, 0, new HTML("What do you need to do to get to your goal salary? "));
		 vendorTable.setWidget(4, 1, expense);
		 vendorTable.setWidget(4, 0, new HTML("What are the limitations to need to over come to get to your goal salary?"));
