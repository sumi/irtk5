...
public class FriendshipsView1 extends Composite {
	 private static FriendshipsView1 instance = null;
	
		protected FriendshipsView1(){
			...
			//////////////////////////////////
		     ...
		     //   final Calendar datingCalendar = new DatingCalendar().getCalendar();
		      ...
		      //  starsLayout.addMember(moneyPlant2); 
		        ...
		        showButton.setTitle("Career Friends");  
		 ...
		 public static FriendshipsView1 getInstance() {
		     if(instance == null) {
		        instance = new FriendshipsView1();
		     }
		     return instance;
		 }
