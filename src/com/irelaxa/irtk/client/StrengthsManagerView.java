...
public class StrengthsManagerView extends Composite {
	...
	private Button registerButton = new Button("Save Your Strengths");
	...
	StrengthsManagerView(){
		...
		vendorTable.setWidget(1, 0, new HTML("<b>Your Strengths Manager</b>"));
		addGoalType();
	...
	public void addGoalType(){
	    ...
	    vendorTable.setWidget(2, 0, new HTML("What is your Number 1 Strength?"));
	    vendorTable.setWidget(2, 1, businessName);
	    vendorTable.setWidget(3, 0, new HTML("What is your Number 2 Strength?"));
		 vendorTable.setWidget(3, 1, product);
		 vendorTable.setWidget(4, 0, new HTML("What is your Number 3 Strength?"));
		 vendorTable.setWidget(4, 1, income);
		 vendorTable.setWidget(4, 0, new HTML("How are you current using your  Number 1 Strength? "));
		 vendorTable.setWidget(4, 1, expense);
		 vendorTable.setWidget(4, 0, new HTML("If you are not currently using your Number 1 Strength, what are the reasons?"));
