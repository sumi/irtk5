...
public class FitnessView1 extends Composite {
	 private static FitnessView1 instance = null;
	
		protected FitnessView1(){
		   ...
		   //     final VLayout mainLayoutTest = new Layout().getMainLayout();
		     ...
		     //   final Calendar datingCalendar = new DatingCalendar().getCalendar();
		      ...
		      //  starsLayout.addMember(moneyPlant2); 
		        ...
		        showButton.setTitle("Fitness Goals");  
		 ...
		 public static FitnessView1 getInstance() {
		     if(instance == null) {
		        instance = new FitnessView1();
		     }
		     return instance;
		 }
