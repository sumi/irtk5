...
public class DietView1 extends Composite {
	 private static DietView1 instance = null;
		...
		protected DietView1(){
		    ...
		    //    starsLayout.addMember(mainLayoutTest);
		      ...
		      //  starsLayout.addMember(moneyPlant2); 
		        ...
		        showButton.setTitle("Health Diet Goals");  
		 ...
		 public static DietView1 getInstance() {
		     if(instance == null) {
		        instance = new DietView1();
		     }
		     return instance;
		 }
