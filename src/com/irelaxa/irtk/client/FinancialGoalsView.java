...
public class FinancialGoalsView extends Composite {
	...
	private Button registerButton = new Button("Save Your Financial Goals");
	...
	FinancialGoalsView(){
		...
		vendorTable.setWidget(1, 0, new HTML("<b>Set Your Financial Goals</b>"));
		addGoalType();
	...
	public void addGoalType(){
	    ...
	    vendorTable.setWidget(2, 0, new HTML("10 Year Networth Goal"));
	    vendorTable.setWidget(2, 1, businessName);
	    vendorTable.setWidget(3, 0, new HTML("5 Year networth Goal"));
		 vendorTable.setWidget(3, 1, product);
		 vendorTable.setWidget(4, 0, new HTML("Income"));
		 vendorTable.setWidget(4, 1, income);
		 vendorTable.setWidget(4, 0, new HTML("Expense"));
		 vendorTable.setWidget(4, 1, expense);
		 vendorTable.setWidget(4, 0, new HTML("Savings"));
