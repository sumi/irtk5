...
public class FamilyGoalsView extends Composite {
	...
	FamilyGoalsView(){
		...
		vendorTable.setWidget(1, 0, new HTML("<b>Set Your Family Goals</b>"));
		addGoalType();
	...
	public void addGoalType(){
	    ...
	    vendorTable.setWidget(2, 0, new HTML("Do you have a Father Like figure in your life?"));
	    vendorTable.setWidget(2, 1, businessName);
	    vendorTable.setWidget(3, 0, new HTML("Do you have Mother like figure in your life?"));
		 vendorTable.setWidget(3, 1, product);
		 vendorTable.setWidget(4, 0, new HTML("Do you have Sister like figure in your life?"));
		 vendorTable.setWidget(4, 1, income);
		 vendorTable.setWidget(4, 0, new HTML("Do you have Brother like figure in your life? "));
		 vendorTable.setWidget(4, 1, expense);
		 vendorTable.setWidget(4, 0, new HTML("If you are married what are the goals for your wife?"));
